...
public class DVLRenderer
{
    ...
    public DVLRESULT Tap(float x, float y, boolean bDouble, boolean changeSelection)
    {
        return DVLRESULT.fromInt( nativeTap(m_handle, x, y, bDouble, changeSelection) );
    }

    public String GetTapURL()
    {
        return nativeGetTapURL(m_handle);
    }
    ...
    static private native int nativeTap(long hRenderer, float x, float y, boolean bDouble, boolean changeSelection);
    static private native String nativeGetTapURL(long hRenderer);
