...
public class PermissionHelper {
    public static final int SETTINGS_REQUEST_CODE = 0x002 << 2;
                    ...
                    .setNegativeButton(negativeButton, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (object instanceof PermissionCallback) {
                                ((PermissionCallback) object).onPermissionDenied(requestCode, Arrays.asList(perms));
                            }
                        }
                    }).create();
            dialog.show();
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (!granted.isEmpty()) {
            // Notify callbacks
            if (object instanceof PermissionCallback) {
                ((PermissionCallback) object).onPermissionGranted(requestCode, granted);
            }
        }
        ...
        if (!denied.isEmpty()) {
            if (object instanceof PermissionCallback) {
                ((PermissionCallback) object).onPermissionDenied(requestCode, denied);
            }
        }
        ...
        if (!granted.isEmpty() && denied.isEmpty()) {
            if (object instanceof PermissionCallback)
                ((PermissionCallback) object).onPermissionAllGranted();
        }
    }
