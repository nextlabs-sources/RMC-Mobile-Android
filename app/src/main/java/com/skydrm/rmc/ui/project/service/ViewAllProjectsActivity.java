...
public class ViewAllProjectsActivity extends BaseActivity implements IProjectContact.IView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_view_all_proejcts);
    ...
    private void initRecyclerView() {
        ...
        mProjectAdapter = new ViewAllProjectAdapter(this);
    ...
    private void showSortMenu() {
        SortMenu menu = new SortMenu(this,
