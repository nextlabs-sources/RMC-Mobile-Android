...
public class SwipeMenuLayout extends FrameLayout implements Openable, Closeable {
    ...
    private boolean swipeRightEnable = true;
    private boolean swipeLeftEnable = true;
    ...
    /**
     * this method is used to enable whether swipe right or not
     *
     * @param swipeEable true or false
     */
    public void setSwipeRightEnable(boolean swipeEable) {
        this.swipeRightEnable = swipeEable;
    }

    /**
     * this method is used to enable whether swipe left or not
     *
     * @param enable true or false
     */
    public void setSwipeLeftEnable(boolean enable) {
        this.swipeLeftEnable = enable;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                isIntercepted = Math.abs(disX) > mViewConfig.getScaledTouchSlop() && Math.abs(disX) > Math.abs(disY);
                break;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(disX) < Math.abs(disY) * TAN) {
                    return false;
                }
    ...
    private void smoothOpenMenu(int duration) {
        if (mSwipeCurrentHorizontal != null) {
            ...
            if (mOnMenuStatusChangeListener != null) {
                mOnMenuStatusChangeListener.onChange(this);
            }
        }
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mSwipeLeftHorizontal != null) {
            ...
            if (swipeLeftEnable) {
                ...
                leftMenu.layout(-menuViewWidth, top, -menuViewWidth, top + menuViewHeight);
            }
        }
        ...
        if (mSwipeRightHorizontal != null) {
            ...
            if (swipeRightEnable) {
                ...
                rightMenu.layout(parentViewWidth, top, parentViewWidth, top + menuViewHeight);
            }
        }
    }
    ...
    public interface OnMenuStatusChangeListener {
        void onChange(SwipeMenuLayout swipeMenuLayout);
    }

    public void setOnMenuStatusChangeListener(OnMenuStatusChangeListener onMenuStatusChangeListener) {
        this.mOnMenuStatusChangeListener = onMenuStatusChangeListener;
    }
}
