...
public class AvatarView extends ImageView {
    ...
    private Bitmap drawableToBitmap(Drawable drawable) {
        ...
        try {
            ...
            if (DEBUG) {
                Log.d(TAG, "drawableToBitmap: " + error + "\"OutOfMemoryError occurred while generating bitmap\"");
            }
            return null;
        }
    }
    ...
    private Bitmap cutIntoCircle(Bitmap bitmap) {
        ...
        try {
            ...
            if (DEBUG) {
                Log.d(TAG, "cutIntoCircle: " + error + "\tOutOfMemoryError occurred while generating bitmap");
            }
            return null;
        }
    }
